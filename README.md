...
[![npm version](https://badge.fury.io/js/ng2-ace-editor-ivy.svg)](https://www.npmjs.com/package/ng2-ace-editor-ivy) 
Ace editor integration with typescript for angular 5.  
**To use Angular 4 install version 0.3.1 (npm i -S ng2-ace-editor-ivy@0.3.1).**

# Install
`npm i -S ng2-ace-editor-ivy`
